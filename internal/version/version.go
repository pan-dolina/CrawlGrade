// Package version exposes build metadata for CrawlGrade.
//
...
//
//	-X github.com/pan-dolina/crawlgrade/internal/version.Version=v0.1.0
var (
	Version = ""
	Commit  = ""
	Date    = ""
...
// UserAgent returns the User-Agent header value CrawlGrade sends by default.
func UserAgent() string {
	return "CrawlGrade/" + Get().Version + " (+https://github.com/pan-dolina/CrawlGrade)"
}
